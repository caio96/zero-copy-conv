...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Summarize correctness results into CSVs.")

    parser.add_argument(
        "CSV_Results", type=str, help="Path to the input CSV file (generated by benchmark_runner)."
    )
