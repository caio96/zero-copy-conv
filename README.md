...
- `filter_models` allows filtering the csv containing convolution layer parameters and getting the models that contain these layers
...
1. Run `filter_models` to get a list of relevant models by filtering with "multithread-heuristic" or "singlethread-heuristic"
